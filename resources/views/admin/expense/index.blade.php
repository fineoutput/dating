          ...
          <div class="card m-b-20">
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-md-2"> <a class="btn btn-info cticket" href="{{route('expense.create')}}" role="button" style="margin-left: 20px;"> Add {{$tital}}</a></div>
              </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="btn-group" id="btns<?php echo $a ?>">
                            ...
                            <form action="{{ route('expense.updateStatus', $data->id) }}" method="POST" style="display:inline;">
                              @csrf
                              @method('PATCH') 
                            ...
                            <a href="{{ route('expense.edit',['id'=> $data->id]) }}" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit info-icon"></i></a>

                          </div>

                          <div style="display:none" id="cnfbox<?php echo $a ?>">
                            <p> Are you sure delete this </p>
                            <form id="deleteForm<?php echo $a; ?>" action="{{ route('expense.destroy',['id'=> $data->id]) }}" method="post" style="display:inline;">
                              @csrf
                              @method('DELETE')
